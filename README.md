...
2. Run `cd directory\that\the\funkin\mods\folder\is\in` to specify which folder the command prompt is working in.
...
3. Run `git clone https://github.com/KeithDaBoi/Funkin-KeithDaBoi-Ver.-.git` to clone the base repository.
